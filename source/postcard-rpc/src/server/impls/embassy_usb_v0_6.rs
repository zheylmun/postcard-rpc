...
use embassy_usb_0_6::driver::{Driver, Endpoint, EndpointError, EndpointIn, EndpointOut};
use serde::Serialize;
...
pub mod dispatch_impl {
    ...
    use embassy_usb_0_6::driver::Driver;
...
pub mod fake {
    ...
    use embassy_usb_0_6::driver::{Bus, ControlPipe, EndpointAddress, EndpointIn, EndpointOut};
    ...
    impl embassy_usb_0_6::driver::Endpoint for FakeEpOut {
        fn info(&self) -> &embassy_usb_0_6::driver::EndpointInfo {
            todo!()
        }
    ...
    impl EndpointOut for FakeEpOut {
        async fn read(
            &mut self,
            _buf: &mut [u8],
        ) -> Result<usize, embassy_usb_0_6::driver::EndpointError> {
            todo!()
        }
    }

    impl embassy_usb_0_6::driver::Endpoint for FakeEpIn {
        fn info(&self) -> &embassy_usb_0_6::driver::EndpointInfo {
            todo!()
        }
    ...
    impl EndpointIn for FakeEpIn {
        async fn write(
            &mut self,
            _buf: &[u8],
        ) -> Result<(), embassy_usb_0_6::driver::EndpointError> {
            todo!()
        }
    }
    ...
    impl Bus for FakeBus {
        ...
        async fn poll(&mut self) -> embassy_usb_0_6::driver::Event {
            todo!()
        }

        fn endpoint_set_enabled(
            &mut self,
            _ep_addr: embassy_usb_0_6::driver::EndpointAddress,
            _enabled: bool,
        ) {
            todo!()
        }
        ...
        async fn remote_wakeup(&mut self) -> Result<(), embassy_usb_0_6::driver::Unsupported> {
            todo!()
        }
    }

    impl embassy_usb_0_6::driver::Driver<'static> for FakeDriver {
        ...
        fn alloc_endpoint_out(
            &mut self,
            _ep_type: embassy_usb_0_6::driver::EndpointType,
            _ep_addr: Option<EndpointAddress>,
            _max_packet_size: u16,
            _interval_ms: u8,
        ) -> Result<Self::EndpointOut, embassy_usb_0_6::driver::EndpointAllocError> {
            todo!()
        }
        ...
        fn alloc_endpoint_in(
            ...
            _max_packet_size: u16,
            _interval_ms: u8,
        ) -> Result<Self::EndpointIn, embassy_usb_0_6::driver::EndpointAllocError> {
            todo!()
        }
